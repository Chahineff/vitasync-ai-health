...
export default function Terms() {
  return (
    ...
    >
      ...
      <p>
        Les présentes Conditions Générales d'Utilisation (ci-après « CGU ») régissent l'accès et l'utilisation de la plateforme VitaSync, accessible à l'adresse vitasync-ai-health.lovable.app (ci-après « la Plateforme »).
      </p>
      <p>
        VitaSync est une plateforme de bien-être et nutrition propulsée par l'intelligence artificielle, proposant un coach IA personnalisé, un suivi de compléments alimentaires, des analyses informatives de résultats sanguins, une boutique en ligne de compléments et des outils de suivi quotidien.
      </p>
      ...
      <p>En créant un compte ou en utilisant la Plateforme, l'Utilisateur accepte sans réserve les présentes CGU ainsi que la Politique de Confidentialité et les Conditions Générales de Vente.</p>

      <h2>2. Définitions</h2>
      <ul>
        <li><strong>« Plateforme »</strong> : Le site web VitaSync et l'ensemble de ses fonctionnalités.</li>
        <li><strong>« Utilisateur »</strong> : Toute personne physique majeure (18 ans+) inscrite sur la Plateforme.</li>
        ...
        <li><strong>« Produits »</strong> : Les compléments alimentaires commercialisés via la boutique VitaSync.</li>
      ...
      <p>Le Coach IA est un assistant conversationnel de bien-être et nutrition fournissant des recommandations personnalisées basées sur le profil de l'Utilisateur. Trois niveaux de modèles sont disponibles : VitaSync Lite, VitaSync 3.0 et VitaSync Pro.</p>
      ...
      <h3>4.4 Boutique VitaSync</h3>
      <p>VitaSync propose un catalogue de compléments alimentaires via Shopify. Les conditions d'achat sont régies par les Conditions Générales de Vente et la Politique de Livraison et Retours.</p>
      ...
      <p>
        <strong>Responsabilité IA :</strong> Conformément à la Directive (UE) 2024/2853 sur la responsabilité du fait des produits (applicable à partir du 9 décembre 2026), VitaSync sera soumis à un régime de responsabilité stricte pour les défauts liés à l'IA. Les clauses de limitation de responsabilité des présentes CGU ne peuvent pas exclure cette responsabilité légale.
      </p>
      ...
      <ul>
        <li><strong>Free :</strong> Accès gratuit aux fonctionnalités de base (Coach IA Lite, suivi compléments, check-ins).</li>
        <li><strong>Go :</strong> Abonnement payant avec Coach IA 3.0, analyses sanguines et fonctionnalités avancées.</li>
        <li><strong>Premium :</strong> Abonnement premium avec Coach IA Pro, analyses illimitées, quiz interactifs.</li>
      </ul>
      <p>Les achats de compléments via la boutique sont indépendants de l'abonnement et régis par les CGV. Les abonnements sont gérés via Shopify pour le paiement et la facturation.</p>
      ...
      <p>L'Utilisateur conserve la propriété de ses données personnelles et de santé. En utilisant la Plateforme, l'Utilisateur accorde à VitaSync une licence limitée et non exclusive d'utilisation de ses données aux seules fins de fourniture du service.</p>
