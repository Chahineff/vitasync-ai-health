...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Content Container - 40/60 Layout */}
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 py-24 grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-center">
        ...
        <div className="lg:col-span-2 text-center lg:text-left">
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-[-0.04em] text-foreground mb-6 leading-[1.1] hero-text-shadow"
          >
            Votre Santé,{" "}
            <span className="gradient-text-hero">Propulsée par l'IA</span>
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-base md:text-lg lg:text-xl text-foreground/70 mb-10 leading-relaxed"
          >
        ...
        {/* Right Side - Spline 3D (60%) */}
        <motion.div 
          ref={splineContainerRef}
          className="lg:col-span-3 h-[400px] sm:h-[500px] lg:h-[600px] relative"
        ...
        >
          ...
          {/* Subtle glow effect behind the 3D */}
