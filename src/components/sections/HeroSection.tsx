...
export function HeroSection() {
  ...
  const heroCards = [
    ...
    },
    {
      ...
      iconClassName: "text-primary",
      titleClassName: "text-primary",
      className: "[grid-area:stack] translate-x-[4.5rem] translate-y-[11.5rem] hover:translate-y-[3rem]",
    },
  ];

  return (
    <section ref={sectionRef} className="relative min-h-screen overflow-hidden rounded-b-[2.5rem] md:rounded-b-[3.5rem]">
