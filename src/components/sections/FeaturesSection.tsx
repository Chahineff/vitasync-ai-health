...
const features = [
  {
    ...
    subtitle: "Propulsé par Gemini 3 Flash",
    description: "Votre assistant personnel répond à vos questions de santé à tout moment, par chat ou par voix.",
    details: [
      "Intelligence artificielle de dernière génération (Google Gemini)",
      "Sources médicales vérifiées et mises à jour en continu",
      "Reconnaissance vocale avancée pour des échanges naturels",
      "Historique de conversations sauvegardé et contextualisé"
    ],
  ...
  },
  {
    ...
    subtitle: "Analyse continue de vos données",
    description: "L'IA analyse vos données continuellement et ajuste ses recommandations automatiquement.",
    details: [
      "Tableaux de bord personnalisés avec graphiques d'évolution",
      "Alertes intelligentes en cas d'anomalie détectée",
      "Recommandations ajustées selon vos progrès",
      "Synchronisation avec vos habitudes quotidiennes"
    ],
  ...
  },
  {
    ...
    subtitle: "Import PDF et photo intelligent",
    description: "Importez vos résultats d'analyses (PDF/Photos) pour des recommandations ultra-précises.",
    details: [
      "OCR avancé pour extraction automatique des données",
      "Interprétation instantanée de 50+ biomarqueurs",
      "Comparaison avec les normes optimales (pas juste \"normales\")",
  ...
  },
  {
    ...
    subtitle: "Certifié et tracé de A à Z",
    description: "Compléments de grade médical, testés en laboratoire, avec traçabilité complète.",
    details: [
      "Ingrédients sourcés auprès de fournisseurs certifiés",
      "Tests de pureté par laboratoires indépendants",
      "Formulations biodisponibles de haute absorption",
      "QR code de traçabilité sur chaque produit"
    ],
    gradient: "from-primary via-accent to-secondary",
    bgGradient: "from-primary/10 via-accent/5 to-secondary/10",
  },
];
    ...
    >
      ...
      >
        <GlassCard className="h-full p-6 md:p-8 lg:p-10">
          ...
          <div className={`w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br ${feature.gradient} p-0.5 mb-6`}>
          ...
          {/* Subtitle badge */}
          <span className={`inline-block text-xs font-medium uppercase tracking-widest bg-gradient-to-r ${feature.gradient} bg-clip-text text-transparent mb-3`}>
            {feature.subtitle}
          </span>
      ...
      >
        <div className={`relative aspect-[4/3] rounded-3xl overflow-hidden bg-gradient-to-br ${feature.bgGradient}`}>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            ...
            >
              <div className={`w-20 h-20 md:w-28 md:h-28 rounded-2xl bg-gradient-to-br ${feature.gradient} p-1`}>
          ...
          >
            <div className={`w-6 h-6 md:w-8 md:h-8 rounded-lg bg-gradient-to-br ${feature.gradient}`} />
          </motion.div>
          ...
          >
            <div className={`w-4 h-4 md:w-6 md:h-6 rounded-full bg-gradient-to-br ${feature.gradient}`} />
          </motion.div>
        </div>
      </motion.div>
    </motion.div>
