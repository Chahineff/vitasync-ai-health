...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl mt-12 md:mt-16 mx-auto h-[30rem] md:h-[40rem] w-full border-2 border-border/50 dark:border-border/30 p-2 md:p-6 bg-card rounded-[30px] shadow-2xl"
    >
