...
export function HeroSection() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex items-center pt-24 pb-12 overflow-hidden">
      ...
      <div className="relative z-10 py-8 lg:py-20 px-6 sm:px-10 lg:px-16">
        <div className="max-w-3xl text-left">
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-light tracking-tight text-foreground mb-4 md:mb-6 text-balance leading-tight"
          >
            Votre Santé,{" "}
