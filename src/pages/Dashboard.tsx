        ...
        <div className="px-4 flex-1">
          ...
          <nav className="space-y-1 relative">
            <Link
              ...
              className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-light text-foreground/70 hover:bg-white/50 hover:text-foreground transition-all"
            >
              <BookOpen weight="light" className="w-5 h-5 flex-shrink-0" />
