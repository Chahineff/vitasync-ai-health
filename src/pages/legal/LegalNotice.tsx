...
export default function LegalNotice() {
  return (
    ...
    >
      ...
      <p>Conformément à l'article 6 III-1 de la Loi n° 2004-575 du 21 juin 2004 pour la Confiance dans l'Économie Numérique (LCEN), le site vitasync.ai est édité par :</p>
